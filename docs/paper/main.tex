...
Rules were developed using the training split of the publicly available dataset.
Performance during development was monitored on a separate validation split. A
held-out test split was reserved for final evaluation and was not used for rule
modification. All results reported in this paper, including
Table~\ref{tab:ssnhl-results}, correspond to the held-out test split.
